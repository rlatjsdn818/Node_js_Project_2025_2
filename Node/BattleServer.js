...
class BattleServer {
    ...
    startBattle(player1Id, player2Id) {
        ...
        const battle = {
            ...
            player1: player1Id,
            player2: player2Id,
            currentTurn: player1Id, // 첫 턴은 player1
            turnCount: 1,
    ...
    processBattleAction(battle, attackerId, action) {
        ...
        switch (action) {
            ...
            case 'defend':
                ...
                // 다음 턴에 방어 효과 (구현 생략, 확장 가능)
                break;

            case 'skill':
                damage = Math.floor(Math.random() * 25) + 20; // 20~44 데미지 (강력하지만 랜덤)
    ...
    endBattle(battle, winnerId) {
        ...
        console.log(`배틀 종료: ${winner.name} 승리!`);
        ...
        if (player && player.inBattle) {
            ...
            if (battle) {
                ...
                this.sendToPlayer(opponentId, {
                    ...
                    message: '상대방이 연결을 종료했습니다. 당신이 승리했습니다!'
                });
